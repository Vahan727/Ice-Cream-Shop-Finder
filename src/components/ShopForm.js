    ...
    return (
        <div className="new-shop-form">
          ...
          <form onSubmit={(e)=>{handleOnSubmit(e)}}>
            ...
            <input type="number" name="cost" step="0.1" placeholder="Cost in $" value={formData.cost} onChange={handleOnChange}/>
            <input type="text" name="location" placeholder="Shop location" value={formData.location} onChange={handleOnChange}/>
            <input type="number" name="rating" step="1" max= "5" placeholder="Shop Rating- max is 5" value={formData.rating} onChange={handleOnChange}/>
